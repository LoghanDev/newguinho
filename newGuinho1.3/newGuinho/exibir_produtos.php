...
require_once 'inc_exibir_produtos.php';
?>
            ...
            <div class="col">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        <div class="col">
                        <img class="img-fluid" src="https://edelzio.com/uploads/<?php echo $produtoDetalhado['foto']; ?>" >
                        </div>
                        <div class="col">
                            <h1><?php echo $produtoDetalhado['nome']; ?></h1>
                            <p>Preço: R$ <?php echo $produtoDetalhado['preco']; ?></p>
                            <p style="margin-top:-15px;">Descrição: R$ <?php echo $produtoDetalhado['descricao']; ?></p>
                            <form method="POST" action="pedidos.php?action=add&id=<?php echo $produtoDetalhado['id']; ?>">
                                <input type="submit" class="btn btn-primary text-white btn-lg" style="width: 200px;" value="Comprar">
                            </form>
                        </div>
